...
/**
 * Implementation of the 'imageDescriptionTitle_default_formatter' formatter.
 *
 * @FieldFormatter(
 *   id = "imageDescriptionTitle_default_formatter",
 ...
 * )
 */
class ImageDescriptionTitleDefaultFormatter extends ImageFormatter {
