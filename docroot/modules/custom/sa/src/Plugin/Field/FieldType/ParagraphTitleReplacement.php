...
namespace Drupal\sa\Plugin\Field\FieldType;
...
/**
 * Plugin implementation of the 'paragraph_title_replacement' field type.
 *
 * @FieldType(
 *   id = "paragraph_title_replacement",
 *   label = @Translation("Title replacement"),
 *   description = @Translation("Special field that grabs the highest parent it can find and uses that title if this field is empty"),
 *   default_widget = "paragraph_title_replacement_widget",
 *   default_formatter = "title_replacement_formatter"
 * )
 */
class ParagraphTitleReplacement extends StringItem {
