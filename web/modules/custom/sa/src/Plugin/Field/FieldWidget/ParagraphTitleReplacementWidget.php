...
namespace Drupal\sa\Plugin\Field\FieldWidget;

use Drupal\Core\Field\FieldItemListInterface;
use Drupal\Core\Field\Plugin\Field\FieldWidget\StringTextfieldWidget;
use Drupal\Core\Form\FormStateInterface;
use Drupal\sa\Plugin\Field\FieldType\ParagraphTitleReplacement;

/**
 * Plugin implementation of the 'paragraph_title_replacement_widget' widget.
 *
 * @FieldWidget(
 *   id = "paragraph_title_replacement_widget",
 ...
 * )
 */
class ParagraphTitleReplacementWidget extends StringTextfieldWidget {
  ...
  public static function defaultSettings() {
    return [
      ...
      'allowed_wrapper_tags' => ParagraphTitleReplacement::getPossibleOptions(),
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    $element['allowed_wrapper_tags'] = [
      '#type' => 'checkboxes',
      '#options' => ParagraphTitleReplacement::getPossibleOptions(),
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element['wrapper'] = [
      ...
      '#type' => 'select',
      // Same states as the title replacement.
      '#states' => [
        'visible' => [
          ':input[data-state-selector="' . $selector . '"]' => ['checked' => TRUE],
        ],
    ...
    if (count($allowed_options) === 1) {
      ...
      $element['wrapper'] = [
        '#type' => 'hidden',
        '#value' => isset($items[$delta]->wrapper) ? $items[$delta]->wrapper : 'h1',
      ];
    }
