...
/**
 * @file
 * Contains Drupal\sa_paragraphs\Form\SettingsForm.
 */

namespace Drupal\sa_paragraphs\Form;
 ...
 * Class SettingsForm.
 *
 * @package Drupal\sa_paragraphs\Form
 */
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('sa_paragraphs.settings');

    $form['sa_p_styling_settings'] = [
      '#type' => 'fieldset',
      '#title' => t('Styling settings'),
      '#open' => TRUE,
    ];

    $form['sa_p_styling_settings']['css_structural'] = [
      '#type' => 'checkbox',
    ...
    $form['sa_p_styling_settings']['css_colors'] = [
      '#type' => 'checkbox',
    ...
    $form['sa_p_styling_settings']['backgrounds_full'] = [
      '#type' => 'checkbox',
    ...
    while ($i < $this->variationAmount) {
      ...
      $form['color_variants_group'][$i]['name'] = [
        '#type' => 'textfield',
        '#title' => t('Name'),
        '#default_value' => $variants[$i]['name'] ?? NULL,
      ...
      $form['color_variants_group'][$i]['foreground'] = [
        ...
        '#default_value' => $variants[$i]['foreground'] ?? NULL,
      ...
      $form['color_variants_group'][$i]['background'] = [
        ...
        '#default_value' => $variants[$i]['background'] ?? NULL,
      ...
      $form['color_variants_group'][$i]['link'] = [
        '#type' => 'textfield',
        '#title' => t('Link color'),
        '#default_value' => $variants[$i]['link'] ?? NULL,
      ...
      $form['color_variants_group'][$i]['hover'] = [
        ...
        '#default_value' => $variants[$i]['hover'] ?? NULL,
   ...
   *   Form state.
   */
  public function rpSettingsAddItem(array $form, FormStateInterface $form_state): void {
   ...
   */
  public function rpSettingAjaxCallback(array $form, FormStateInterface $form_state): array {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    $config->set('css_structural', $form_state->getValue('css_structural'))
      ->save();
    $config->set('css_colors', $form_state->getValue('css_colors'))
      ->save();
